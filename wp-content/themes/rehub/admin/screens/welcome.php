			...
			<div class="rehub-registration-steps">
		    	<div class="feature-section col three-col">
		        	...
		        	<div class="col">
						...
						<p><?php echo __( "Enter your ThemeForest username, purchase code and generated API key into the fields below. This will give you access to automatic theme updates, demo stacks, support, etc.", "rehub_framework" ); ?></p>
		            </div>               	
