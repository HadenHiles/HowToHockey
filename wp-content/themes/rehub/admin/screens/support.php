	...
	<div class="rehub-registration-steps">
    	<div class="feature-section col three-col">
            ...
            <div class="col">
                ...
                <?php printf( '<a href="%s" class="button button-large button-primary rehub-large-button" target="_blank">%s</a>', 'http://rehub.wpsoul.com/documentation/docs.html', __( "Documentation", "rehub_framework" ) ); ?>
            </div>
