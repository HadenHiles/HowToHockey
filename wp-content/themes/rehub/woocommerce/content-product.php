...
if (rehub_option('woo_design') == 'grid')
	$classes[] = 'grid_woo_a';
if (rehub_option('woo_columns') == '3_col')
	$classes[] = 't_col_woo';
if (rehub_option('woo_columns') == '4_col')
	$classes[] = 'f_col_woo';
if (rehub_option('woo_btn_disable') == '1')
	$classes[] = 'non_btn';
?>
...
<?php if(!empty($offer_coupon_date)) : ?>
	...
	$classes[] = $coupon_style;                
	?>
<?php endif ;?>
<?php if(!empty($offer_coupon_mask)) {$classes[] = 'reveal_enabled';}?>
