...
function widget( $args, $instance ) {
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Top offers', 'rehub_framework'), 'number' => 5, 'tag' => '', 'post_type' => 'post', 'order' => '', 'tags' =>'', 'random' =>'');
		...
		<p><em><?php _e('If you select Widget base on posts or woocommerce, enter tag slug in field below. If you select ThirstyAffiliate base, widget will show top links of ThirstyAffiliates posts and you can set slug of thirstyaffiliates category. Also, you can set name of meta key for ordering or show random products', 'rehub_framework');?></em></p>
