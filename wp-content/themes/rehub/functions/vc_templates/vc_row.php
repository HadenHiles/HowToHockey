...
//rehub custom
if ($bg_width_type !='' && $bg_width_type!='simple') {
	$wrapper_attributes[] = 'data-bg-width="'.$bg_width_type.'"';
}
if ($rehub_container !='' && $bg_width_type=='simple'){
	$css_classes[] = ' vc_rehub_container';
}
elseif ($bg_width_type=='container_width' || $bg_width_type=='window_width'){
	$css_classes[] = ' vc_custom_row_width';
}
