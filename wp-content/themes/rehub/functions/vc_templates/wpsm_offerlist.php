    ...
    <div class="block_with_coupon">
        ...
        <div class="buttons_col">
            ...
            <?php if(!empty($offer_coupon_date)) : ?>
                ...
                ?>
            <?php endif ;?> 
                <div><a class="btn_offer_block" href="<?php echo $link; ?>" rel="nofollow" target="_blank"><?php if($offer_btn_text !='') :?><?php echo $offer_btn_text ; ?><?php elseif(rehub_option('rehub_btn_text') !='') :?><?php echo rehub_option('rehub_btn_text') ; ?><?php else :?><?php _e('Buy this item', 'rehub_framework') ?><?php endif ;?></a></div>
